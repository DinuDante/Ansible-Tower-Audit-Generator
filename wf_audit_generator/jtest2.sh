...
for i in $(seq $count); do
	...
	curl -k -H "Authorization:  Bearer <Authentication-Token>" -H "Content-Type: application/json" -X GET  -d "{}"  https://<FQDN>/api/v2/workflow_job_templates/?page=$i >> /root/wf_audit_generator/jreport.json
